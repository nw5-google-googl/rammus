...
const scriptsInEvents = {
	...
	async Y8api_Event23_Act1(runtime, localVars)
	{
		ID.init({
		        appId : localVars.ID
		    });
	...
	{
		runtime.globalVars["isRewardReceived"] = jsRewardRecevied;
	},
	...
	async Y8api_Event20_Act3(runtime, localVars)
	{
		jsRewardRecevied = 0;
	},

	async Y8api_Event24_Act1(runtime, localVars)
	{
		showReward()
