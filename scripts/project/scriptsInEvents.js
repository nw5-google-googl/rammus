...
const scriptsInEvents = {
	...
	async Advertise_Event57_Act1(runtime, localVars)
	{
	...
	async Yandex_Event2_Act1(runtime, localVars)
	{
		ysdk.adv.showRewardedVideo({
		    callbacks: {
		        ...
		        onRewarded: () => {
		            ...
		            runtime.globalVars.isRewardSucceed = true;
		        },
		        onClose: () => {
		            if (runtime.globalVars.isRewardSucceed) {
		                console.log('Video ad closed successfully.');
						runtime.callFunction("rewardedAdFinished");
		            } else {
		                console.log('Video ad closed, but no reward was given.');
		            }
		            runtime.callFunction("onClose");
		        },
		        onError: (e) => {
		            console.log('Error while opening video ad:', e);
		            runtime.callFunction("onError");
		        }
		    }
		})
